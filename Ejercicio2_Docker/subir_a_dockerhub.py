...
if __name__ == "__main__":
    image_name = "295topics-fullstack_frontend"
    dockerfile_path = "/root/295devops-groupo4/Ejercicio2_Docker/bootcamp-devops-2023/295topics-fullstack"  # Ruta donde esta Dockerfile
