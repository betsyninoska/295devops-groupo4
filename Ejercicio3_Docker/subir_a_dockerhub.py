...
if __name__ == "__main__":
    image_name = "295words-docker_api"
    dockerfile_path = "/root/295devops-groupo4/Ejercicio3_Docker/bootcamp-devops-2023/295words-docker/web"  # Ruta donde esta Dockerfile
